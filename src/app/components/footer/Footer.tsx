const FooterColumn = ({title, items}:{title:string, items:{link: string; name:string}[]}) => 
    <div>
...
const Footer =  () =>
    <footer className="bg-sky-950 text-white">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm sm:text-center dark:text-gray-400">Built with Next.js and Tailwind
            </span>
            <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                <a href="https://twitter.com/i/flow/login?redirect_after_login=%2Fchr_messner" target="_blank" className="hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://github.com/Proteomics-Center-SIAF-UZH" target="_blank" className="hover:text-gray-900 dark:hover:text-white">
