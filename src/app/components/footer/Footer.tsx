    ...
    <footer className="bg-sky-950 text-white">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                <a href="https://twitter.com/i/flow/login?redirect_after_login=%2Fchr_messner" className="hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://www.linkedin.com/in/christoph-messner/" className="hover:text-gray-900 dark:hover:text-white">
